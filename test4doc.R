...
source("/home/michal/Dokumenty/BALCONY/BALCONYfunctions.R")
# source("~/Uczelnia/PROJEKT/BALCONY/BALCONYfunctions.R")
# Set working directory
# setwd("~/Uczelnia/PROJEKT/BALCONY")
setwd("/home/michal/Dokumenty/BALCONY")
getwd()
...
matrix_name="substitution_matrices/GONNET.txt";
